...
func NewTransactionController(logger *zap.Logger, ts models.TransactionService) *TransactionController {
...
func (p *TransactionController) Post(c *gin.Context) {
...
func (p *TransactionController) GetAll(c *gin.Context) {
