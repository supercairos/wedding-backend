...
func (p *ItemController) Post(logger *zap.Logger) func(c *gin.Context) {
...
func (p *ItemController) Put(logger *zap.Logger) func(c *gin.Context) {
	return func(c *gin.Context) {
		var data models.Item
		if err := c.ShouldBindWith(&data, binding.JSON); err != nil {
			c.Error(err)
...
func (p *ItemController) GetAll(logger *zap.Logger) func(c *gin.Context) {
	return func(c *gin.Context) {
...
func (p *ItemController) GetByID(logger *zap.Logger) func(c *gin.Context) {
	return func(c *gin.Context) {
...
func (p *ItemController) Delete(logger *zap.Logger) func(c *gin.Context) {
	return func(c *gin.Context) {
